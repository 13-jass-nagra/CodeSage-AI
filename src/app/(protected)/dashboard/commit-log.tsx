...
import { api } from '@/trpc/react'; // don't include .jsx if you're using .ts or .tsx
        ...
        return <li key={commit.id} className='relative flex gap-x-4'>
          ...
          <div className='flex-auto rounded-mg bg-white p-3 ring-1 ring-inset ring-gray-200'>
            <div className='flex justify-between gap-x-4'>
              <Link target='_blank'
              href={`${project?.githubUrl}/commits/${commit.commitHash}`} className='py-0.5 text-xs leading-5 text-gray-500'>
